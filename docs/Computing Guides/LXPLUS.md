...
### Via the Terminal
On Linux and MacOS systems you can connect to via the terminal by typing:

```ssh yourusername@CERN.CH```

You will then be prompted to enter your password. 

On Windows systems we recommend using [Windows Subsystem for Linux](https://learn.microsoft.com/en-us/windows/wsl/install). After installing you can connect the same way as described above.
...
Then you should be able to connect via the terminal of using VSCode without having to enter your password.
